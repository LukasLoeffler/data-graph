          ...
          <v-container>
            <v-form v-model="valid">
              <v-row>
                ...
                <v-col cols="6">
                  <v-text-field label="Bulp IP" :rules="[rules.required]" v-model="valueCopy.bulbIP"></v-text-field>
                </v-col>
                <v-col cols="6">
                  <v-select label="Action" :rules="[rules.required]" v-model="valueCopy.action" :items="actions"></v-select>
                </v-col>
              </v-row>
            </v-form>
          </v-container>
...
export default {
  data: () => ({
    ...
    type: null,
    actions: [
        {text: "Turn On", value: "on"},
        {text: "Turn Off", value: "off"},
        {text: "Toggle", value: "toggle"},
        {text: "Set Color", value: "color"},
        {text: "Set Brightness", value: "brightness"},
